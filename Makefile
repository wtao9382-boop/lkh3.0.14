...
_OBJ = Activate.o AddCandidate.o AddExtraCandidates.o                  \
       ...
       Penalty_KTSP.o Penalty_OKTSP.o Penalty_M1_PDTSP.o               \
       Penalty_MSCTSP.o Penalty_MTSP.o Penalty_OP.o Penalty_OVRP.o     \
       Penalty_PC_TSP.o Penalty_PDPTW.o Penalty_PDTSP.o                \
	   Penalty_PDTSPF.o Penalty_PCTSP.o Penalty_PTP.o                  \
       Penalty_PDTSPL.o Penalty_PTSP.o Penalty_RCTVRP.o                \
       Penalty_SOP.o Penalty_TOP.o                                     \
	   Penalty_TRP.o Penalty_TSPDL.o Penalty_TSPPD.o                   \
       Penalty_TSPTW.o Penalty_VRPB.o Penalty_VRPBTW.o Penalty_VRPPD.o \
	   Penalty_TSPMD.o                                                 \
	   PCTSP_InitialTour.o PCTSP_RepairTour.o                          \
       ...
       MergeWithTourGPX2.o gpx.o MergeWithTourCLARIST.o LKH.o TOP_WriteSolution.o
